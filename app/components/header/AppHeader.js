				...
				<AppBar className={classNames(classes.appBar, menuOpen && classes.appBarShift)}>
					<div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
						...
						<div className={classes.info}>
							<Icon className={classes.modeIcon}>{mode === APP_MODES.GLOBAL ? 'language' : 'home'}</Icon>
...
export default compose(withStyles(appHeaderStyles, { withTheme: true }), connect(mapStateToProps, mapDispatchToProps))(
	AppHeader
)
