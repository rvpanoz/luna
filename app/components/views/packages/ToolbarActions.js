...
export const SwitchAction = ({ options, handler }) => {
    ...
    return <Tooltip title={iMessage('title', 'switchGlobals')}>
        <div>
            <IconButton
                disableRipple
...
export const FilterAction = ({ options, handler }) => {
    ...
    return <Tooltip title={iMessage('title', 'showFilters')}>
        <div>
            <IconButton
                disableRipple
...
export const RefreshAction = ({ options, handler }) => {
    ...
    return <Tooltip title={fromSearch ? iMessage('title', 'backList') : iMessage('title', 'listReload')}>
        <div>
            <IconButton
                disableRipple
                aria-label="back-reload"
                onClick={handler}
            >
                <RefreshIcon />
            </IconButton>
...
export const ClearFiltersAction = ({ handler }) => <Tooltip title={iMessage('title', 'clearFilters')}>
    <IconButton
        color="secondary"
...
export const InstallAction = ({ handler }) => <Tooltip title={iMessage('title', 'installSelected')}>
    <IconButton
        color="primary"
...
export const LatestAction = ({ handler }) => <Tooltip title={iMessage('title', 'installLatest')}>
    <IconButton
        color="primary"
...
export const UpdateAction = ({ handler }) => <Tooltip title={iMessage('title', 'updateSelected')}>
    <IconButton
        color="primary"
