...
class Layout extends React.Component {
	...
	render() {
		const { classes, theme, settings, menuOpen, handleDrawerOpen, settingsOpen, handleDrawerClose } = this.props
...
export default compose(withStyles(layoutStyles, { withTheme: true }), connect(mapStateToProps, mapDispatchToProps))(
	Layout
)
