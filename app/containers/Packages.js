...
class PackagesContainer extends React.Component {
	constructor() {
		super()
		this._outdated = []
		this._autoBind(['fetch', 'setGlobalMode', '_setupList', '_setupOutdated', '_viewPackage', '_clearUI'])
	}
	componentDidMount() {
		const { setActive, toggleMainLoader, setMode, setPackages, toggleLoader, setPackageJSON } = this.props
